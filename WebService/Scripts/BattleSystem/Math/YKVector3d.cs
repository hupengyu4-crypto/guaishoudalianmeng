...
namespace BattleSystem
{
    public struct YKVector3d
    {
        ...
        public static double PointAngleXZ(YKVector3d a, YKVector3d b)
        {
            return PointRadianXz(a, b) * (180 / Math.PI);
        }
        /// <summary>
        /// 与Y夹角
        /// </summary>
        public static double PointRadianXz(YKVector3d a, YKVector3d b)
        {
